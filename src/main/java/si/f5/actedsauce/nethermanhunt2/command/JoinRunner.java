...
public class JoinRunner implements CommandExecutor {
    public static final String COMMAND_NAME = "joinrunner";
    @Override
    public boolean onCommand(CommandSender commandSender, Command command, String label, String[] args) {
        ...
        if(command.getName().equalsIgnoreCase(COMMAND_NAME)) {
            Main.getTeamManager().AddPlayer((Player) commandSender,Teams.RUNNER);
            return true;
        }
        return false;
    }
